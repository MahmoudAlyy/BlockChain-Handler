...
public class SampleCase {
    ...
    public static void main(String[] args)
        ...
        /*
         * create some transaction tx1, that will have one of its outputs in the pool.
         * We will assume that this one was valid.
         */
        Transaction tx1 = new Transaction();

        /*
         * Let's specify the inputs and outputs of tx1. Since we assume already that tx1
         * is valid, there is no need really to add a proper input here. Compare that
         * when we define tx2 later.
         */
        tx1.addInput(null, 0);

        /*
         * To add an output to the transaction, we need to have the public key of a
         * recipient.
         *
         * Here we are going to generate a key pair. The public key is going to be used
         * by tx1 to specify the recipient, and the private key will be used by the
         * recipient to sign tx2 in order to spend the money. This generation step
         * should happen on the second side, but this is just simulating everything on
         * one machine)
         */
        ...
        /*
         * let's sign with our private key to prove the ownership of the first public
         * key specified by the tx1 output
         */
        ...
        /*
         * Now let's try to see if tx2 is valid: This should return true in your code,
         * but that's easy; you should think of more involved scenarios: many
         * transactions, what could go wrong, .. etc.
         */
